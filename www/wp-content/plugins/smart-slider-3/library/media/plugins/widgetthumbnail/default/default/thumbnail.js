(function ($, scope, undefined) {
    ...
    NextendSmartSliderWidgetThumbnailDefault.prototype.start = function (id, parameters) {
        ...
        this.parameters = $.extend({captionSize: 0}, parameters);
    ...
    NextendSmartSliderWidgetThumbnailDefault.prototype.goToDot = function (i) {
        ...
        if (itemPerPane <= 1.5) {
            ...
            availableBarDimension = barDimension - sideDimension * 2;
            ratio = availableBarDimension / (1.5 * this.thumbnailDimension[variables.prop]);
            itemPerPane = availableBarDimension / (this.thumbnailDimension[variables.prop] * ratio);
        }

        if (this.ratio != ratio) {
            var css = {};
            css[variables.prop] = this.thumbnailDimension[variables.prop] * ratio;
            var scrollerDimension = css[variables.invProp] = (this.thumbnailDimension[variables.invProp] - this.parameters['captionSize']) * ratio + this.parameters['captionSize'];
            this.dots.css(css);
            css = {};
            css[variables.prop] = this.imageDimension[variables.prop] * ratio;
            css[variables.invProp] = this.imageDimension[variables.invProp] * ratio;
            this.images.css(css);
